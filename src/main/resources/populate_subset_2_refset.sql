...
values (100032, 'GB English Language reference set', 900000000000508004, 'Great Britain English language reference set (foundation metadata concept)', 'Refset/Content/');
