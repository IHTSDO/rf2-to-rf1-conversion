...
* Qualifying relationships are not included, with the exception of Laterality Qualifying relationships which are optionall generated if a laterality references file can be provided.
...
### Running on a MAC
A script file go.sh has been provided to simplify the crafting of the java jar file call with a large number of parameters.
...
<code>How much memory do you have available? [10g]: 
Do you have a 2nd drive (eg D:\) Y/N: Y
Where is the RF2 Archive [G:\incoming\xSnomedCT_RF2Release_INT_20160731.zip]: </code>
